...
SMPLX_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="hord/data/assets/usd/smplx_humanoid.usda",
...
SMPL_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="hord/data/assets/usd/smpl_humanoid.usda",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
H1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="hord/data/assets/usd/h1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="hord/data/assets/usd/g1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
        ...
        joint_drive_props=sim_utils.JointDrivePropertiesCfg(
            stiffness=None,  # N*m/rad (revolute joints); N/m (prismatic joints)
            damping=None,  # N*m*s/rad (revolute joints); N*s/m (prismatic joints)
        )
    ),
    soft_joint_pos_limit_factor=0.9,
)
