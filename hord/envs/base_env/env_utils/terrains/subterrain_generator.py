...
from hord.envs.base_env.env_utils.terrains.shape_utils import (
    draw_circle,
    draw_curve,
    draw_disk,
    draw_ellipse,
...
def sloped_subterrain(subterrain: SubTerrain, slope=1):
    ...
    Parameters:
        subterrain (hord.envs.base_env.env_utils.terrains.route_subterrain.RouteSubTerrain): the terrain
